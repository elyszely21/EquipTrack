...
class UserRegistrationForm(forms.ModelForm):
    ...
    suffix = forms.CharField(required=False, widget=forms.TextInput(attrs={"class": "form-control"}))
    ...
    def clean_role(self):
        ...
        allowed_roles = {choice[0] for choice in self.PUBLIC_ROLE_CHOICES}

        if role not in allowed_roles:
            raise forms.ValidationError("Invalid registration role.")
